...
public partial class ForwarderControl : UserControl
{
    ...
    private int FMessageIcon(ForwarderMessageType t) => t switch
    {
        ForwarderMessageType.ACTIVATED or ForwarderMessageType.DEACTIVATED => 0,
        ForwarderMessageType.ERROR => 1,
        ForwarderMessageType.TSTART => 2,
        ForwarderMessageType.TSEND => 3,
        ForwarderMessageType.TRECV => 4,
        ForwarderMessageType.TEND => 5,
        _ => 1,
    };
    ...
    public override string ToString() => fw.ToString();
    ...
    private void lvHistory_DoubleClick(object sender, EventArgs e)
    {
        if (lvHistory.SelectedItems.Count <= 0)
            return;
        var t = lvHistory.SelectedItems[0].Tag as Transmission;
        if (t != null)
